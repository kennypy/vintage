    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.section, { backgroundColor: theme.card }]}>
        ...
        <View style={styles.step}>
          ...
          <Text style={[styles.stepText, { color: theme.textSecondary }]}>Escolha um anúncio para impulsionar</Text>
        </View>
        <View style={styles.step}>
          <View style={styles.stepNum}><Text style={styles.stepNumText}>2</Text></View>
          <Text style={[styles.stepText, { color: theme.textSecondary }]}>Seu anúncio aparece no topo das buscas por 24h</Text>
        </View>
        <View style={styles.step}>
          <View style={styles.stepNum}><Text style={styles.stepNumText}>3</Text></View>
          <Text style={[styles.stepText, { color: theme.textSecondary }]}>Receba mais visitas e venda mais rápido</Text>
        </View>
      </View>
