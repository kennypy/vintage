...
import { getFollowing, type FollowListItem } from '../../../src/services/users';
...
export default function FollowingScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Segue {total} {total === 1 ? 'pessoa' : 'pessoas'}</Text>
      <FlatList
        data={items}
        keyExtractor={(i) => i.id}
        ListEmptyComponent={<Text style={styles.empty}>Ainda não segue ninguém.</Text>}
        renderItem={({ item }) => (
